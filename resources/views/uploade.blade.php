...
<div  class="container"> 
    ...
    Ajouter une image de profil pour le combantant
    </h3>
        ...
        <div class="card text-center">
            <div class="card-body">
                ...
                <div class="profile-img p-3">
                    <img src="{{ asset('img/img-profil.png') }}" id="profile-pic">
                </div>
 ...
 $(function() {
    ...
    $("#upload").on("click", function() {
        croppie.result('base64').then(function(base64) {
            ...
            formData.append("idcombatants", "{{ $combatant->idcombatants }}");
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data == "uploaded") {
                       return location = "{{ route('gestion_combatants.index') }}" ;
                    } else {
