...
<head>
  ...
  <body class="bg-light">
    ...
    <main role="main" class="container-fluid">
      <div class="">
        <div class="row">
          <div class="col-12 d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm" style="height: 120px">
            <img class="mr-3" src="{{ url(Storage::url($combatant->picture)) }}" alt="" width="75" height="75">
            <div class="lh-100">
              <h1 class="mb-0 text-white lh-100">
                {{ $combatant->nom .' '.$combatant->prenom  }}
              </h1>
              <br>
              <small>Poid : {{ $combatant->poid  }}Kg</small><br>
              <small>Catégorie : {{ $combatant->lib  }}</small>
            </div>
          </div>
      ...
      <div class=" ">
        ...
        <div class="affiche-panel row">
          <div class="col-5 ">
            <div class="affiche-content">
              <div class="affiche-img-panel">
                <img src="{{ url(Storage::url($combatant->picture)) }}" class="affiche-img img-fluid" width="500" height="500">
              </div> 
            </div>
          </div>
          <div class="col-2"></div>
                 ...
                 {{--  <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $combatant->postnom }}</td>
                    </tr>
                    <tr>
                      <th scope="row">Prenom</th>
                      <td>{{ $combatant->prenom }}</td>
                    </tr>
                    <tr>
          ...
          <a href="{{ route('upload-img-combatant',$combatant->idcombatants) }}" class="btn btn-info">Modifier l'image de profil</a>
